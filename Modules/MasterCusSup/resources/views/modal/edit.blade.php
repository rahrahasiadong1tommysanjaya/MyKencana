    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Customer dan Supplier</h5>
                ...
                <form id="formEdit" class="formEdit" autocomplete="off" novalidate>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <select id="jns-edit" name="jns" class="selectJenis form-select form-select-md"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="alm" class="form-label fs-6">Alamat <span class="text-danger small">*
                                    ...
                                    provinsi</span></label>
                            <textarea id="alm-edit" name="alm" class="form-control" placeholder="Masukkan alamat" autocomplete="off" required></textarea>
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            ...
                            <select id="kel-edit" name="kel" class="selectKelurahan form-select form-select-md"
                                data-allow-clear="true" required>
                            </select>
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" id="kec-edit" name="kec" class="form-control" autocomplete="off"
                                readonly>
                        </div>
                        <div class="col-sm-3">
                            <label for="kab_kota" class="form-label fs-6">Kabupaten/Kota</label>
                            <input type="text" id="kab_kota-edit" name="kab_kota" class="form-control"
                                autocomplete="off" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label for="prov" class="form-label fs-6">Provinsi</label>
                            <input type="text" id="prov-edit" name="prov" class="form-control" autocomplete="off"
                                readonly>
                        </div>
                    </div>
