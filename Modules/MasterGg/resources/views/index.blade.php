...
@section('page-script')
    @vite(['resources/assets/js/currencyFormatter.js', 'modules/masterGg/resources/assets/js/index.js', 'modules/masterGg/resources/assets/js/modal/edit.js'])
@endsection

@section('title', 'Master GGg')
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive">
            <table class="listmasterGG table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn-tambah btn btn-primary me-1 mb-1">
                                <i class="fa fa-save opacity-50 me-1 float-right"></i> Tambah Group GL
                            </button>
                        </td>
                    </tr>
                </thead>
